...
if isfolder("VSDDL_Packages")
    lib.rmpath(fullfile(pwd,"VSDDL_Packages"))
    lib.rmpath(fullfile(pwd,"VSDDL_Packages/ControlSystemModel"))
    lib.rmpath(fullfile(pwd,"VSDDL_Packages/MADCASPCore"))
    lib.rmpath(fullfile(pwd,"VSDDL_Packages/PropellerData"))
    lib.rmpath(fullfile(pwd,"VSDDL_Packages/Waypoints"))
end
